...
public class CustomAdapter extends RecyclerView.Adapter<CustomAdapter.ViewHolder> {
     ...
     */
    Context context;
    public CustomAdapter(Details[] dataSet, Context context) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        final  Details temp=localDataSet[position];
        ...
        textView19.setText(localDataSet[position].s5);
        textView20.setText(localDataSet[position].s6);
        textView15.setText(localDataSet[position].s7);
        ...
        imageView6.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                intent.putExtra("S5",temp.s5);
                intent.putExtra("S6",temp.s6);
                intent.putExtra("S7",temp.s7);
