...
public class CustomAdapter1 extends RecyclerView.Adapter<CustomAdapter1.ViewHolder> {
     ...
     */
    Context context;
    public CustomAdapter1(Details3[] dataSet, Context context) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        ...
        View view = LayoutInflater.from(viewGroup.getContext())
                .inflate(R.layout.hotel, viewGroup, false);
    ...
    public void onBindViewHolder(ViewHolder viewHolder, final int position) {
        ...
        final  Details3 temp=localDataSet[position];
